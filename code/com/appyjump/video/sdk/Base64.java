...
public class Base64
{
  ...
  public static byte[] decode(char[] paramArrayOfChar)
  {
    ...
    if (i < k)
    {
      ...
      i1 = map2[m];
      n = map2[n];
      if ((i5 < 0) || (i4 < 0) || (i1 < 0) || (n < 0)) {
        throw new IllegalArgumentException("Illegal character in Base64 encoded data. " + i3);
      }
      m = j + 1;
      arrayOfByte[j] = ((byte)(i5 << 2 | i4 >>> 4));
      if (m >= i2) {
        break label340;
      }
      j = m + 1;
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\appyjump\video\sdk\Base64.class
