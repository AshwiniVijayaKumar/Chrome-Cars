...
public final class GooglePlayServicesUtil
{
  ...
  public static Dialog a(int paramInt1, Activity paramActivity, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener, int paramInt3)
  {
    ...
    paramOnCancelListener = new ef(paramActivity, a(paramActivity, paramInt1, paramInt3), paramInt2);
    ...
    catch (Throwable localThrowable)
    {
      ...
      catch (PackageManager.NameNotFoundException paramContext)
      {
        try
        {
          ...
          localObject = a((PackageInfo)localObject, yL);
          if (localObject != null) {
            break label113;
          }
      ...
      label113:
      tmp118_115[0] = localObject;
      if (a(paramContext, tmp118_115) == null)
      {
  ...
  public static boolean showErrorDialogFragment(int paramInt1, Activity paramActivity, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    if (i != 0)
    {
      ...
      b.a(localDialog, paramOnCancelListener).show(paramActivity, "GooglePlayServicesErrorDialog");
    }
    for (;;)
    {
      return true;
  ...
  private static boolean u(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramContext = a(paramContext.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), yR);
        if (paramContext != null) {
          return true;
        }
      }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\common\GooglePlayServicesUtil.class
