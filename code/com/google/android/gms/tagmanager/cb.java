  ...
  implements at
{
  ...
  void a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfString = this.VN;
        if (cq() == 0)
        {
          paramArrayOfString.p(bool);
          return;
        }
      }
  ...
  int cp()
  {
    ...
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.Ty.currentTimeMillis() - 2592000000L) });
    Object localObject = this.VN;
    if (cq() == 0) {}
    for (;;)
    {
      ((au)localObject).p(bool);
      return i;
      bool = false;
    }
  }
  ...
  int js()
  {
    ...
    //   3: aload_0
    //   4: ldc -124
    //   6: invokespecial 134	com/google/android/gms/tagmanager/cb:G	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   38: aconst_null
    //   39: aconst_null
    //   40: invokevirtual 342	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   43: astore_3
    //   44: aload_3
    //   45: invokeinterface 345 1 0
    //   50: istore_2
    //   51: iload_2
    //   52: istore_1
    //   53: aload_3
    ...
    //   69: astore_3
    //   70: ldc_w 347
    //   73: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
  ...
  List<String> s(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 352
    //   16: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 354
    //   26: invokespecial 134	com/google/android/gms/tagmanager/cb:G	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   182: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  public List<ap> t(int paramInt)
  {
    ...
    //   9: aload_0
    //   10: ldc_w 378
    //   13: invokespecial 134	com/google/android/gms/tagmanager/cb:G	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   112: ifeq +54 -> 166
    //   115: aload 7
    //   117: new 380	com/google/android/gms/tagmanager/ap
    //   120: dup
    //   121: aload 4
    //   123: iconst_0
    ...
    //   145: invokespecial 383	com/google/android/gms/tagmanager/ap:<init>	(JJJ)V
    ...
    //   278: checkcast 380	com/google/android/gms/tagmanager/ap
    //   281: aload 6
    //   283: iconst_1
    //   284: invokeinterface 401 2 0
    //   289: invokevirtual 404	com/google/android/gms/tagmanager/ap:F	(Ljava/lang/String;)V
    //   292: aload 6
    ...
    //   356: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   359: aload 4
    //   361: astore 6
    //   363: aload 5
    //   365: ifnull -338 -> 27
    ...
    //   420: checkcast 380	com/google/android/gms/tagmanager/ap
    //   423: invokevirtual 409	com/google/android/gms/tagmanager/ap:ci	()J
    ...
    //   433: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   436: goto -144 -> 292
    //   439: astore 5
    //   441: aload 6
    //   443: astore 4
    ...
    //   477: invokestatic 117	com/google/android/gms/tagmanager/bh:w	(Ljava/lang/String;)V
    //   480: aload 4
    //   482: astore 5
    ...
    //   533: checkcast 380	com/google/android/gms/tagmanager/ap
    //   536: astore 8
    //   538: aload 4
    //   540: astore 5
    //   542: aload 8
    //   544: invokevirtual 427	com/google/android/gms/tagmanager/ap:jf	()Ljava/lang/String;
    ...
    extends SQLiteOpenHelper
  {
    ...
    {
      if ((this.ui) && (this.uj + 3600000L > cb.a(cb.this).currentTimeMillis())) {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\tagmanager\cb.class
