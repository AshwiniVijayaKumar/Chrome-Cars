...
public class dz
{
  ...
  public static Calendar V(String paramString)
  {
    ...
    Object localObject2 = W(paramString);
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      xE.b("Invalid date format", new Object[0]);
      return null;
    }
    String str = X(paramString);
    ...
    for (paramString = "yyyyMMdd'T'HHmmss";; paramString = yF)
    {
      ...
      {
        label127:
        xE.b("Error parsing string: %s", new Object[] { paramString.getMessage() });
      }
    }
    return null;
  }
  ...
  private static String W(String paramString)
  {
    ...
    {
      xE.c("Error extracting the date: %s", new Object[] { paramString.getMessage() });
    }
    return null;
  }
  ...
  private static String X(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          xE.b("Error extracting the time substring: %s", new Object[] { paramString.getMessage() });
          return null;
        }
    ...
    } while (paramString.length() != "HHmmss".length() + yE[0].length());
  ...
  public static String a(Calendar paramCalendar)
  {
    ...
    return ((String)localObject).replace("+0000", yE[0]);
  }
  ...
  public static void a(JSONObject paramJSONObject, List<WebImage> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext()) {
        localJSONArray.put(((WebImage)paramList.next()).cT());
      }
    }
    try
    {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\internal\dz.class
