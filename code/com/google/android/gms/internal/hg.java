    ...
    implements hg
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        localObject2 = paramParcel1.createTypedArrayList(hj.CREATOR);
        localObject1 = localObject7;
        if (paramParcel1.readInt() != 0) {
          localObject1 = (PendingIntent)PendingIntent.CREATOR.createFromParcel(paramParcel1);
        }
        a((List)localObject2, (PendingIntent)localObject1, hf.a.O(paramParcel1.readStrongBinder()), paramParcel1.readString());
      ...
      case 2: 
        ...
        a((PendingIntent)localObject1, hf.a.O(paramParcel1.readStrongBinder()), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
      ...
      case 8: 
        ...
        a((LocationRequest)localObject1, a.a.N(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
      ...
      case 14: 
        ...
        if (paramParcel1.readInt() != 0)
        {
          ...
          localObject2 = hn.CREATOR.aw(paramParcel1);
          if (paramParcel1.readInt() == 0) {
            break label968;
          }
        }
        for (localObject3 = id.CREATOR.aD(paramParcel1);; localObject3 = null)
        {
          a((LatLngBounds)localObject1, paramInt1, (hn)localObject2, (id)localObject3, hv.a.R(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 15: 
        ...
        if (paramParcel1.readInt() != 0) {
          localObject1 = id.CREATOR.aD(paramParcel1);
        }
        a((String)localObject2, (id)localObject1, hv.a.R(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 16: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        ...
        for (localObject2 = hn.CREATOR.aw(paramParcel1);; localObject2 = null)
        {
          if (paramParcel1.readInt() != 0) {
            localObject3 = id.CREATOR.aD(paramParcel1);
          }
          a((LatLng)localObject1, (hn)localObject2, (id)localObject3, hv.a.R(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 17: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        if (paramParcel1.readInt() != 0) {}
        for (localObject1 = hn.CREATOR.aw(paramParcel1);; localObject1 = null)
        {
          localObject2 = localObject5;
          if (paramParcel1.readInt() != 0) {
            localObject2 = id.CREATOR.aD(paramParcel1);
          }
          a((hn)localObject1, (id)localObject2, hv.a.R(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      case 42: 
        ...
        b((String)localObject2, (id)localObject1, hv.a.R(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 18: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        if (paramParcel1.readInt() != 0)
        {
          localObject1 = hr.CREATOR.ay(paramParcel1);
          if (paramParcel1.readInt() == 0) {
            break label1323;
          }
        }
        for (localObject2 = id.CREATOR.aD(paramParcel1);; localObject2 = null)
        {
      ...
      case 19: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        if (paramParcel1.readInt() != 0) {}
        for (localObject1 = id.CREATOR.aD(paramParcel1);; localObject1 = null)
        {
      ...
      case 20: 
        ...
        a((LocationRequest)localObject1, a.a.N(paramParcel1.readStrongBinder()), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 21: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
      ...
      case 25: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        if (paramParcel1.readInt() != 0) {}
        for (paramParcel2 = hp.CREATOR.ax(paramParcel1);; paramParcel2 = null)
        {
          if (paramParcel1.readInt() != 0) {
            localObject1 = id.CREATOR.aD(paramParcel1);
          }
      ...
      implements hg
    {
        ...
        throws RemoteException
      {
        ...
        //   56: aload_0
        //   57: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   60: iconst_5
        //   61: aload 6
        //   63: aload 7
        //   65: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   33: bipush 11
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramPendingIntent != null)
            {
              ...
              if (paramhf != null)
              {
                paramPendingIntent = paramhf.asBinder();
        ...
        throws RemoteException
      {
        ...
        //   35: aload_0
        //   36: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   39: bipush 26
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   36: aload_0
        //   37: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   40: iconst_4
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   34: bipush 10
        //   36: aload_2
        //   37: aload_3
        //   38: iconst_0
          ...
          try
          {
            ...
            if (paramLatLngBounds != null)
            {
              ...
              if (paramhn != null)
              {
                ...
                paramLatLngBounds = paramhv.asBinder();
        ...
        throws RemoteException
      {
        ...
        //   17: aload 4
        //   19: aload_1
        //   20: invokevirtual 131	android/os/Parcel:writeStringArray	([Ljava/lang/String;)V
        //   23: aload_2
        //   24: ifnull +54 -> 78
        //   27: aload_2
        ...
        //   46: aload_0
        //   47: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   50: iconst_3
        //   51: aload 4
        //   53: aload 5
        //   55: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   19: aload_0
        //   20: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   23: bipush 21
        //   25: aload_2
        //   26: aload_3
        //   27: iconst_0
        ...
        //   38: aload_3
        //   39: invokevirtual 137	android/os/Parcel:readInt	()I
        //   42: ifeq +26 -> 68
        //   45: getstatic 141	android/location/Location:CREATOR	Landroid/os/Parcelable$Creator;
        //   48: aload_3
        ...
        throws RemoteException
      {
        ...
        //   39: invokevirtual 137	android/os/Parcel:readInt	()I
        //   42: ifeq +21 -> 63
        //   45: getstatic 154	com/google/android/gms/location/b:CREATOR	Lcom/google/android/gms/location/c;
        //   48: aload_3
        //   49: invokevirtual 160	com/google/android/gms/location/c:au	(Landroid/os/Parcel;)Lcom/google/android/gms/location/b;
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 60	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   11: invokevirtual 34	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
        //   14: aload_0
        //   15: getfield 18	com/google/android/gms/internal/hg$a$a:ky	Landroid/os/IBinder;
        //   18: bipush 7
        //   20: aload_2
        //   21: aload_3
        //   22: iconst_0
        ...
        //   33: aload_3
        //   34: invokevirtual 137	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 141	android/location/Location:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 147 2 0
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\internal\hg.class
