...
public class i
  extends CollectionMetadataField<String>
{
  ...
  protected Collection<String> a(DataHolder paramDataHolder, int paramInt1, int paramInt2)
  {
    try
    {
      paramDataHolder = as(paramDataHolder.getString(getName(), paramInt1, paramInt2));
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\drive\metadata\internal\i.class
