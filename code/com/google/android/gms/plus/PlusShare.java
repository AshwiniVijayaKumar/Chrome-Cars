...
public final class PlusShare
{
  ...
  public static class Builder
  {
    ...
    public Intent getIntent()
    {
      ...
      int i;
      boolean bool1;
      if ((this.Rc != null) && (this.Rc.size() > 1))
      {
        i = 1;
        ...
        bool1 = true;
        label59:
        er.a(bool1, "Call-to-action buttons are only available for URLs.");
        if ((bool4) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label312;
        }
        bool1 = true;
        label84:
        er.a(bool1, "The content URL is required for interactive posts.");
        bool1 = bool2;
        if (bool4)
        {
          bool1 = bool2;
        ...
        label125:
        er.a(bool1, "Must set content URL or content deep-link ID to use a call-to-action button.");
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\plus\PlusShare.class
