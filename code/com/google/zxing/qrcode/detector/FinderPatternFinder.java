...
public class FinderPatternFinder
{
  ...
  private float crossCheckHorizontal(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      if ((i < 0) || (!localBitMatrix.get(i, paramInt2)))
      {
        j = i;
        if (i >= 0) {
          break;
    ...
    for (;;)
    {
      if ((paramInt1 >= k) || (!localBitMatrix.get(paramInt1, paramInt2)))
      {
        i = paramInt1;
        if (paramInt1 != k) {
          break;
  ...
  private float crossCheckVertical(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      if ((i < 0) || (!localBitMatrix.get(paramInt2, i)))
      {
        j = i;
        if (i >= 0) {
          break;
    ...
    for (;;)
    {
      if ((paramInt1 >= k) || (!localBitMatrix.get(paramInt2, paramInt1)))
      {
        i = paramInt1;
        if (paramInt1 != k) {
          break;
    ...
    throws NotFoundException
  {
    ...
    if (i > 3)
    {
      ...
      if (!localIterator.hasNext())
      {
        ...
        i = 0;
        label101:
        if ((i < this.possibleCenters.size()) && (this.possibleCenters.size() > 3)) {
          break label297;
        }
      }
    }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\qrcode\detector\FinderPatternFinder.class
