...
public abstract class ResultParser
{
  ...
  public static ParsedResult parseResult(Result paramResult)
  {
    ...
    for (;;)
    {
      Object localObject;
      if (i >= j) {
        localObject = new TextParsedResult(paramResult.getText(), null);
      }
      ParsedResult localParsedResult;
      do
      {
        return (ParsedResult)localObject;
        localParsedResult = arrayOfResultParser[i].parse(paramResult);
        localObject = localParsedResult;
      } while (localParsedResult != null);
      i += 1;
    }
  }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\client\result\ResultParser.class
