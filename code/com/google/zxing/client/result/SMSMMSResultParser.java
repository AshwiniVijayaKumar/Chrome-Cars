  ...
  extends ResultParser
{
  ...
  public SMSParsedResult parse(Result paramResult)
  {
    ...
    if ((j < 0) || (i == 0))
    {
      str = ((String)localObject2).substring(4);
      i = -1;
    ...
    for (;;)
    {
      ...
      if (j <= i)
      {
        ...
        str = ((String)localObject2).substring(4, j);
        break;
      }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\client\result\SMSMMSResultParser.class
