...
final class DecodedBitStreamParser
{
  ...
  private static String getMessage(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((localStringBuilder.length() <= 0) || (localStringBuilder.charAt(localStringBuilder.length() - 1) != 65532))
      {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\maxicode\decoder\DecodedBitStreamParser.class
