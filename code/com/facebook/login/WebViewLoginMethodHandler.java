  ...
  extends LoginMethodHandler
{
  ...
  boolean tryAuthorize(final LoginClient.Request paramRequest)
  {
    ...
    for (;;)
    {
      ...
      this.loginDialog = new AuthDialogBuilder((Context)localObject, paramRequest.getApplicationId(), localBundle).setE2E(this.e2e).setIsRerequest(paramRequest.isRerequest()).setOnCompleteListener(local1).setTheme(FacebookSdk.getWebDialogTheme()).build();
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\facebook\login\WebViewLoginMethodHandler.class
