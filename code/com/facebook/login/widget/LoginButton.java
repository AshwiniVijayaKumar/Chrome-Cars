    ...
    implements View.OnClickListener
  {
    ...
    public void onClick(View paramView)
    {
      ...
      if (localAccessToken != null) {
        ...
        {
          localObject1 = LoginButton.this.getResources().getString(R.string.com_facebook_loginview_log_out_action);
          ...
          {
            paramView = String.format(LoginButton.this.getResources().getString(R.string.com_facebook_loginview_logged_in_as), new Object[] { paramView.getName() });
            ...
            label157:
            paramView = AppEventsLogger.newLogger(LoginButton.this.getContext());
      ...
      for (int i = 0;; i = 1)
      {
        ...
        paramView.logSdkEvent(LoginButton.this.loginLogoutEventName, null, (Bundle)localObject1);
        return;
        paramView = LoginButton.this.getResources().getString(R.string.com_facebook_loginview_logged_in_using_facebook);
        break;
        LoginButton.this.getLoginManager().logOut();
        break label157;
        paramView = LoginButton.this.getLoginManager();
        paramView.setDefaultAudience(LoginButton.this.getDefaultAudience());
        paramView.setLoginBehavior(LoginButton.this.getLoginBehavior());
        if (LoginAuthorizationType.PUBLISH.equals(LoginButton.access$600(LoginButton.this).authorizationType))
        {
          if (LoginButton.this.getFragment() != null)
          {
            paramView.logInWithPublishPermissions(LoginButton.this.getFragment(), LoginButton.access$600(LoginButton.this).permissions);
            break label157;
          }
          paramView.logInWithPublishPermissions(LoginButton.this.getActivity(), LoginButton.access$600(LoginButton.this).permissions);
          break label157;
        }
        if (LoginButton.this.getFragment() != null)
        {
          paramView.logInWithReadPermissions(LoginButton.this.getFragment(), LoginButton.access$600(LoginButton.this).permissions);
          break label157;
        }
        paramView.logInWithReadPermissions(LoginButton.this.getActivity(), LoginButton.access$600(LoginButton.this).permissions);
        break label157;
      }
    }
  }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\facebook\login\widget\LoginButton.class
