...
public final class FacebookSdk
{
  ...
  public static void sdkInitialize(Context paramContext, InitializeCallback paramInitializeCallback)
  {
    ...
    //   13: ifnull +9 -> 22
    //   16: aload_1
    //   17: invokeinterface 547 1 0
    //   22: ldc 2
    //   24: monitorexit
    //   25: return
    //   26: aload_0
    //   27: ldc_w 548
    //   30: invokestatic 552	com/facebook/internal/Validate:notNull	(Ljava/lang/Object;Ljava/lang/String;)V
    //   33: aload_0
    //   34: iconst_0
    //   35: invokestatic 556	com/facebook/internal/Validate:hasFacebookActivity	(Landroid/content/Context;Z)V
    //   38: aload_0
    //   39: iconst_0
    //   40: invokestatic 559	com/facebook/internal/Validate:hasInternetPermissions	(Landroid/content/Context;Z)V
    //   43: aload_0
    ...
    //   53: invokestatic 561	com/facebook/FacebookSdk:loadDefaultsFromMetadata	(Landroid/content/Context;)V
    //   56: getstatic 158	com/facebook/FacebookSdk:applicationContext	Landroid/content/Context;
    //   59: getstatic 179	com/facebook/FacebookSdk:applicationId	Ljava/lang/String;
    //   62: invokestatic 564	com/facebook/internal/Utility:loadAppSettingsAsync	(Landroid/content/Context;Ljava/lang/String;)V
    //   65: invokestatic 569	com/facebook/internal/NativeProtocol:updateAllAvailableProtocolVersionsAsync	()V
    //   68: getstatic 158	com/facebook/FacebookSdk:applicationContext	Landroid/content/Context;
    //   71: invokestatic 574	com/facebook/internal/BoltsMeasurementEventListener:getInstance	(Landroid/content/Context;)Lcom/facebook/internal/BoltsMeasurementEventListener;
    //   74: pop
    //   75: new 242	com/facebook/internal/LockOnGetVariable
    //   78: dup
    //   79: new 8	com/facebook/FacebookSdk$2
    //   82: dup
    //   83: invokespecial 575	com/facebook/FacebookSdk$2:<init>	()V
    //   86: invokespecial 578	com/facebook/internal/LockOnGetVariable:<init>	(Ljava/util/concurrent/Callable;)V
    //   89: putstatic 240	com/facebook/FacebookSdk:cacheDir	Lcom/facebook/internal/LockOnGetVariable;
    //   92: new 580	java/util/concurrent/FutureTask
    //   95: dup
    //   96: new 10	com/facebook/FacebookSdk$3
    //   99: dup
    //   100: aload_1
    //   101: invokespecial 583	com/facebook/FacebookSdk$3:<init>	(Lcom/facebook/FacebookSdk$InitializeCallback;)V
    //   104: invokespecial 584	java/util/concurrent/FutureTask:<init>	(Ljava/util/concurrent/Callable;)V
    //   107: astore_0
    //   108: invokestatic 522	com/facebook/FacebookSdk:getExecutor	()Ljava/util/concurrent/Executor;
    //   111: aload_0
    //   112: invokeinterface 530 2 0
    //   117: iconst_1
    //   118: invokestatic 151	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   121: putstatic 153	com/facebook/FacebookSdk:sdkInitialized	Ljava/lang/Boolean;
    //   124: goto -102 -> 22
    //   127: astore_0
    //   128: ldc 2
    //   130: monitorexit
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\facebook\FacebookSdk.class
