      ...
      try
      {
        ...
        if ((k > 0) && (j > 0))
        {
          ...
          if (localAttributionIdentifiers.getAndroidAdvertiserId() == null)
          {
            localObject1 = localObject3;
            localObject2 = localObject3;
            localAttributionIdentifiers.androidAdvertiserId = ((Cursor)localObject3).getString(k);
            localObject1 = localObject3;
            localObject2 = localObject3;
            localAttributionIdentifiers.limitTracking = Boolean.parseBoolean(((Cursor)localObject3).getString(j));
          }
        }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\facebook\internal\AttributionIdentifiers.class
