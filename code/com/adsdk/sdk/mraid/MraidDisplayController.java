  ...
  extends MraidAbstractController
{
  ...
  private Runnable mCheckViewabilityTask = new Runnable()
  {
    public void run()
    {
      ...
      {
        MraidDisplayController.this.mIsViewable = bool;
  ...
  private void swapViewWithPlaceholderView()
  {
    ...
    {
      if (i >= j) {}
      while (localViewGroup.getChildAt(i) == getView())
      {
  ...
  protected void setNativeCloseButtonEnabled(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if (this.mCloseButton == null)
      {
        ...
        Drawable localDrawable = ResourceManager.getStaticResource(getView().getContext(), -29);
        ((StateListDrawable)localObject2).addState(new int[] { -16842919 }, localDrawable);
        localDrawable = ResourceManager.getStaticResource(getView().getContext(), -29);
        ((StateListDrawable)localObject2).addState(new int[] { 16842919 }, localDrawable);
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\adsdk\sdk\mraid\MraidDisplayController.class
