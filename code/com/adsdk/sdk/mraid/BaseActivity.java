  ...
  extends Activity
{
  ...
  protected void showInterstitialCloseButton()
  {
    if (this.mCloseButton == null)
    {
      ...
      Drawable localDrawable = ResourceManager.getStaticResource(this, -29);
      ((StateListDrawable)localObject).addState(new int[] { -16842919 }, localDrawable);
      localDrawable = ResourceManager.getStaticResource(this, -30);
      ((StateListDrawable)localObject).addState(new int[] { 16842919 }, localDrawable);
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\adsdk\sdk\mraid\BaseActivity.class
