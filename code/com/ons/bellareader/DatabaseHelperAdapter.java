...
public class DatabaseHelperAdapter
{
  ...
  {
    open();
    if (this.mDb.rawQuery("SELECT * FROM Bookmarkurls where pageurl='" + paramString2 + "' and xvalue=" + paramInt2, null).getCount() > 0)
    {
      close();
      return true;
    }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\com\ons\bellareader\DatabaseHelperAdapter.class
