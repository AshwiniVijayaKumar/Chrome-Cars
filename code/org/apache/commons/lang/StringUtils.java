...
public class StringUtils
{
  ...
  public static String abbreviateMiddle(String paramString1, String paramString2, int paramInt)
  {
    ...
    int m = i / 2;
    StrBuilder localStrBuilder = new StrBuilder(paramInt);
    localStrBuilder.append(paramString1.substring(0, j + i % 2));
    localStrBuilder.append(paramString2);
    localStrBuilder.append(paramString1.substring(k - m));
  ...
  public static String capitalize(String paramString)
  {
    ...
    return new StrBuilder(i).append(Character.toTitleCase(paramString.charAt(0))).append(paramString.substring(1)).toString();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramArrayOfChar[j] == c)
        {
          ...
          {
            bool1 = bool2;
            if (paramArrayOfChar[(j + 1)] == paramString.charAt(i + 1)) {
              break;
            }
          }
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramArrayOfChar[k] == c)
        {
          ...
          j = i;
          if (paramArrayOfChar[(k + 1)] == paramString.charAt(i + 1)) {
            break;
          }
        }
        k += 1;
  ...
  public static int indexOfAnyBut(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      j = 1;
      if ((i + 1 >= k) || (!CharUtils.isHighSurrogate(c))) {
        break label105;
      }
      m = paramString1.charAt(i + 1);
      if (j == 0) {
        break;
      }
      j = i;
    } while (paramString2.indexOf(m) < 0);
    label99:
    label105:
    while (j != 0)
    {
  ...
  public static int indexOfAnyBut(String paramString, char[] paramArrayOfChar)
  {
    ...
    if (i < m)
    {
      ...
      for (;;)
      {
        ...
        if ((paramArrayOfChar[k] == c) && ((i >= m - 1) || (k >= n - 1) || (!CharUtils.isHighSurrogate(c)) || (paramArrayOfChar[(k + 1)] == paramString.charAt(i + 1))))
        {
          i += 1;
          break label32;
        }
  ...
  public static String join(Object[] paramArrayOfObject, char paramChar, int paramInt1, int paramInt2)
  {
    ...
    {
      localStrBuilder = new StrBuilder(j * (i + 1));
      i = paramInt1;
      while (i < paramInt2)
      {
        if (i > paramInt1) {
  ...
  public static String replace(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      i = 16;
      localStrBuilder = new StrBuilder(paramString1.length() + j * i);
      i = paramInt;
      paramInt = m;
    }
    for (j = k;; j = paramString1.indexOf(paramString2, paramInt))
    {
      ...
      if (j != -1)
      {
        localStrBuilder.append(paramString1.substring(paramInt, j)).append(paramString3);
        paramInt = j + i1;
        i -= 1;
        if (i == 0) {
          k = paramInt;
      ...
      {
        localStrBuilder.append(paramString1.substring(k));
        return localStrBuilder.toString();
        if (paramInt > 64) {
          break;
        }
  ...
  private static String replaceEach(String paramString, String[] paramArrayOfString1, String[] paramArrayOfString2, boolean paramBoolean, int paramInt)
  {
    ...
    while (n != -1)
    {
      ...
      localStrBuilder.append(paramArrayOfString2[i1]);
  ...
  public static String uncapitalize(String paramString)
  {
    ...
    return new StrBuilder(i).append(Character.toLowerCase(paramString.charAt(0))).append(paramString.substring(1)).toString();
  }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\org\apache\commons\lang\StringUtils.class
