  ...
  extends MessageFormat
{
  ...
  private int readArgumentIndex(String paramString, ParsePosition paramParsePosition)
  {
    ...
    while ((i == 0) && (paramParsePosition.getIndex() < paramString.length()))
    {
      ...
      if (((c1 == ',') || (c1 == '}')) && (localStrBuilder.length() > 0)) {
        try
        {
          i = Integer.parseInt(localStrBuilder.toString());
          return i;
        }
    ...
    do
    {
      ...
      while (localParsePosition.getIndex() < paramString.length()) {
        ...
        case '{': 
          ...
          localStrBuilder.append('{').append(k);
          seekNonWs(paramString, localParsePosition);
          localObject2 = null;
          localObject1 = null;
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\org\apache\commons\lang\text\ExtendedMessageFormat.class
