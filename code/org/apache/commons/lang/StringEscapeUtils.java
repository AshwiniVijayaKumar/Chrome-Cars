    ...
    do
    {
      ...
      if (k < m)
      {
        ...
        for (;;)
        {
          ...
          {
            throw new NestableRuntimeException("Unable to parse unicode value: " + localStrBuilder, paramWriter);
          }
          if (i != 0)
          {
            i = 0;
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\org\apache\commons\lang\StringEscapeUtils.class
