  ...
  extends MarkerIgnoringBase
{
  ...
  {
    return MessageFormatter.format(paramString, paramObject1, paramObject2).getMessage();
  }
  
  private String format(String paramString, Object[] paramArrayOfObject)
  {
    return MessageFormatter.arrayFormat(paramString, paramArrayOfObject).getMessage();
  }
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\org\slf4j\impl\AndroidLogger.class
