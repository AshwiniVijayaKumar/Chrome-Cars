  ...
  implements Serializable
{
  ...
  public int hashCode()
  {
    ...
    for (int i3 = this.mediaFile.hashCode();; i3 = 0)
    {
      ...
      return ((((((((i * 31 + i5) * 31 + j) * 31 + k) * 31 + m) * 31 + n) * 31 + i1) * 31 + i2) * 31 + i3) * 31 + i4;
      i = 0;
      break;
      j = 0;
      break label51;
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\twitter4j\StatusUpdate.class
