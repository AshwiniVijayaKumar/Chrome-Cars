  ...
  implements Serializable, Relationship
{
  ...
  public int hashCode()
  {
    ...
    for (;;)
    {
      return (((((((((i5 * 31 + i) * 31 + j) * 31 + k) * 31 + m) * 31 + n) * 31 + i1) * 31 + i2) * 31 + i6) * 31 + i3) * 31 + i4;
      i = 0;
      break;
      label194:
      j = 0;
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\twitter4j\RelationshipJSONImpl.class
