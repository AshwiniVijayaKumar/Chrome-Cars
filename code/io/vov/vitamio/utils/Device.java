...
public class Device
{
  ...
  public static String getIdentifiers(Context paramContext)
  {
    ...
    label154:
    for (paramContext = "-1";; paramContext = String.valueOf(paramContext.getActiveNetworkInfo().getType()))
    {
  ...
  private static String getPair(String paramString1, String paramString2)
  {
    ...
    label48:
    for (paramString2 = "";; paramString2 = paramString2.trim())
    {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\io\vov\vitamio\utils\Device.class
