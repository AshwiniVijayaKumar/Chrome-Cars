...
public class MediaScanner
{
      ...
      try
      {
        ...
        try
        {
          ...
          if (this.mCaseInsensitivePaths)
          {
            ...
            this.mFileCache.put(localObject, new FileCacheEntry(MediaStore.Video.Media.CONTENT_URI, l2, str2, l1));
            continue;
            paramString = finally;
          }
        }
  ...
  public void scanDirectories(String[] paramArrayOfString)
  {
    ...
    catch (UnsupportedOperationException paramArrayOfString)
    {
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\io\vov\vitamio\MediaScanner.class
