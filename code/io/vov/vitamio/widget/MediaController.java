  ...
  extends FrameLayout
{
  ...
  private SeekBar.OnSeekBarChangeListener mSeekListener = new SeekBar.OnSeekBarChangeListener()
  {
    public void onProgressChanged(SeekBar paramAnonymousSeekBar, int paramAnonymousInt, boolean paramAnonymousBoolean)
    {
      ...
      {
        return;
        long l = MediaController.this.mDuration * paramAnonymousInt / 1000L;
        paramAnonymousSeekBar = StringUtils.generateTime(l);
        if (MediaController.this.mInstantSeeking) {
          MediaController.this.mPlayer.seekTo(l);
        }
        if (MediaController.this.mInfoView != null) {
          MediaController.this.mInfoView.setText(paramAnonymousSeekBar);
        }
      } while (MediaController.this.mCurrentTime == null);
      MediaController.this.mCurrentTime.setText(paramAnonymousSeekBar);
    }
    ...
    {
      if (!MediaController.this.mInstantSeeking) {
        MediaController.this.mPlayer.seekTo(MediaController.this.mDuration * paramAnonymousSeekBar.getProgress() / 1000L);
      }
      if (MediaController.this.mInfoView != null)
      {
        MediaController.this.mInfoView.setText("");
  ...
  private void updatePausePlay()
  {
    ...
    if (this.mPlayer.isPlaying())
    {
      this.mPauseButton.setImageResource(getResources().getIdentifier("mediacontroller_pause_button", "drawable", this.mContext.getPackageName()));
      return;
    }
    this.mPauseButton.setImageResource(getResources().getIdentifier("mediacontroller_play_button", "drawable", this.mContext.getPackageName()));
  }
  ...
  public void setWindowLayoutType()
  {
    ...
    try
    {
      this.mAnchor.setSystemUiVisibility(256);
  ...
  public void show(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.mAnchor.getLocationOnScreen((int[])localObject);
...
/* Location:              C:\Users\ADMIN\Desktop\foss\dex2jar-2.0\classes-dex2jar.jar!\io\vov\vitamio\widget\MediaController.class
