...
(function( $, window, undefined ) {
	...
	$.extend( $.mobile, {
		...
		resetActivePageHeight: function( height ) {
			...
			if(mobileADS)
			{
			    var appPageName = sessionStorage.getItem("AppPageName");
				var checkAppStr = "directory|news|ecommerce";
				if((checkAppStr.indexOf(appPageName) == -1))
				{
					height = height - 53;
				}
			}
			...
			$("#contentHolder,#contentHolder1,#contentHolder2,#contentHolder3,#contentHolder4,#contentHolder5,#contentHolder6,#contentHolder7,#contentHolder8,#contentHolder9,#contentHolder10,#contentHolder11,#contentHolder12,#contentHolder13,#register,#forgotpassword,#contentHolder14,#contentHolder15,#contentHolder16,#contentHolder17,#contentHolder18,#contentHolder19,#contentHolder20,#contentHolder21,#contentHolder22,#contentHolder23").css("height", (height - ( pageOuterHeight - pageHeight )+parseFloat( page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom"))));
			//alert(height);
	...
	$(".appypie_quiz").css("height", (height - ( pageOuterHeight - pageHeight )-quizH+parseFloat( page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom"))));
	$(".app_navigation_list.centered-option").css("height", (height - ( pageOuterHeight - pageHeight )-80 + parseFloat( page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom"))));
	},
